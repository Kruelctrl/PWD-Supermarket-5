...
class RegisterPage extends React.Component {
    ...
    userValid = (e) => {
        ...
        if (symb.test(username) || username.length < 5) return this.setState({ userValidErr: [true, "*Can\'t include symbol and min 5 char"] })
    ...
    passValid = (e) => {
        ...
        if (!symb.test(pass) || !numb.test(pass) || pass.length < 5) return this.setState({ passValidErr: [true, "*Must include symbol, number, min 5 char"] })
...
const styles = {
    container: {
        background: "url(https://images.unsplash.com/photo-1592930937768-5c7885464099?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=750&q=80) no-repeat center",
